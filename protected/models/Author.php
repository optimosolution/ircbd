...
class Author extends CActiveRecord {
    ...
    public static function get_picture($id) {
        ...
        $filePath = Yii::app()->basePath . '/../uploads/author/' . $value->author_photo;
        if ((is_file($filePath)) && (file_exists($filePath))) {
            return CHtml::image(Yii::app()->baseUrl . '/uploads/author/' . $value->author_photo, 'Picture', array('alt' => $value->author_name, 'class' => 'img-circle', 'title' => $value->author_name, 'style' => 'width:100px;'));
        } else {
