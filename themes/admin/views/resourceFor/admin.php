...
$this->pageTitle = 'Resource For - ' . Yii::app()->name;
...
$('.search-form form').submit(function(){
	$('#resource-for-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
            ...
            $this->widget('bootstrap.widgets.TbGridView', array(
                ...
                'columns' => array(
                    ...
                    array(
                        'name' => 'resource_for',
                        'type' => 'raw',
                        'value' => '$data->resource_for',
                        'htmlOptions' => array('style' => "text-align:left;", 'title' => 'Resource For'),
                    ),
                    array(
                        'name' => 'ordering',
                        'type' => 'raw',
