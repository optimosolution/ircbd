...
$this->pageTitle = 'Resource Types - ' . Yii::app()->name;
...
$('.search-form form').submit(function(){
	$('#resource-type-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
            ...
            $this->widget('bootstrap.widgets.TbGridView', array(
                ...
                'columns' => array(
                    ...
                    array(
                        ...
                        'htmlOptions' => array('style' => "text-align:left;", 'title' => 'Resource Type'),
                    ),
                    array(
                        'header' => 'Actions',
