...
<?php
$this->pageTitle = 'Edit Author - ' . Yii::app()->name;
$this->breadcrumbs = array(
    'Authors' => array('admin'),
    $model->author_name => array('view', 'id' => $model->id),
    'Update',
);
Yii::app()->clientScript->registerScript('banner', "
    $('#Author_author_photo').ace_file_input({
        no_file: 'No file ...',
        btn_choose: 'Choose',
        btn_change: 'Change',
        droppable: false,
...
<div class="widget-box">
    <div class="widget-header">
        <h5>Edit Author (<?php echo $model->author_name; ?>)</h5>
